  ...
  <q-card class="bg-transparent no-shadow no-border">
    ...
    <q-card-section class="q-mx-sm">
      <div class="row q-col-gutter-lg">
        <div class="col-lg-3 col-sm-12 col-xs-12 col-md-3" v-for="(data, index) in getData" :key="index">
  ...
  computed: {
    getData() {
      if (this.type == 'All') {
        ...
        return cards_data.filter( item => item.type.toLowerCase() === this.type.toLowerCase() )
      }
    },
  }
})
